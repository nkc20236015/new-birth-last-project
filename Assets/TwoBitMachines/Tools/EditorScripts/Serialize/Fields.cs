...
namespace TwoBitMachines.Editors
{
        ...
        public static class Fields
        {
                ...
                public static void EventField (SerializedProperty onEvent, float adjustX = 0, Color? color = null, bool execute = true, bool noGap = false)
                {
                        ...
                        Rect rect = Block.BasicRect(Layout.longInfoWidth, height - 1, xoffset: -11, bottomSpace: 1, noGap: noGap, color: GUI.backgroundColor * 0.82f, texture: Icon.Get("HeaderBasic"));
                ...
                public static void EventFoldOut (SerializedProperty onEvent, SerializedProperty toggle, string label, float adjustX = 0, float yOffset = 0, Color color = default(Color), bool execute = true, bool space = true)
                {
                        if (!execute)
                                return;
                        if (space)
