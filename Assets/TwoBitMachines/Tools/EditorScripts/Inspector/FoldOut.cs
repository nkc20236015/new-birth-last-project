...
namespace TwoBitMachines.Editors
{
        ...
        public class Bar
        {
                ...
                public Bar SU (Texture2D texture, Color color, int height, bool topSpace = true)
                {
                        Setup(texture, color, space: topSpace, height: height);
                        return this;
                }
        ...
        public static class FoldOut
        {
                ...
                public static void CornerButtonLR (this SerializedProperty toggle, int xOffset = 0, int yOffset = 0, string icon = "Add", string tooltip = "") // last rect
                {
                        Layout.VerticalSpacing();
                ...
                public static bool CornerButtonLR (Color color, int xOffset = 0, int yOffset = 0, string icon = "Add", string tooltip = "") // last rect
                {
                        Layout.VerticalSpacing();
                        Rect rect = Layout.GetLastRect(23, 23);
                        Rect button = new Rect(rect) { x = rect.x + Layout.longInfoWidth - 34 - xOffset, y = rect.y - 23 - yOffset };
        ...
        public struct BlockStyle : IBlockChild
        {
                ...
                {
                        rect = Block.BasicRect(width: Layout.longInfoWidth - shiftX, height: height, xoffset: -11 + shiftX, noGap: noGap, bottomSpace: bottomSpace, texture: Icon.Get(background), color: color);
        ...
        public struct BlockGrip : IBlockChild
        {
                ...
                public BlockGrip Set (float x, float y, int yOffset = 5, float parentHeight = 18)
                {
                        Set(null, x, y - yOffset, parentHeight, 0, true, false);
                        return this;
                }
        ...
        public struct BlockButton : IBlockChild
        {
                ...
                public BlockButton (string icon, Color? color = null, string ID = "", bool hide = true)
                {
                        iconTexture = Icon.Get(icon);
                        this.hide = hide;
                        this.ID = ID == "" ? icon : ID;
        ...
        public struct BlockField : IBlockChild
        {
                ...
                public BlockField (string field, float weight = 1f, bool invert = false, int yoffset = 0)
                {
                        this.field = field;
                        this.weight = weight;
                ...
                public float Set (System.Object property, float x, float y, float parentHeight, float stretchWidth, bool isOpen, bool hasFold)
                {
                        Rect rect = new Rect() { x = x, y = y + 2 + yoffset, width = stretchWidth * Header.stretchChildren * weight, height = parentHeight - 4 };
                        if (invert)
                        {
        ...
        public struct BlockFieldRaw : IBlockChild
        {
                ...
                public BlockFieldRaw (SerializedProperty property, float weight = 1f, int yoffset = 0)
                {
                        this.property = property;
                        this.weight = weight;
                        this.yoffset = yoffset;
        ...
        public static class Block
        {
                ...
                public static Rect BasicRect (float width, float height, float xoffset = 0, bool noGap = false, float bottomSpace = 0, Texture2D texture = default(Texture2D), Color color = default(Color))
                {
                        ...
                        boxRect = boxRectOrigin = Layout.Set(GUILayoutUtility.GetRect(0, height - offset + bottomSpace), width, height, xoffset, -offset);
                ...
                {
                        int offset = noGap ? 2 : 0;
                        int totalHeight = height * array.IncIfZero().arraySize;
                ...
                public static bool InputAndButtonBox (string title, string icon, Color color, ref string name, int buttonWidth = 15)
                {
                        ...
                        EditorGUI.LabelField(rect.Adjust(0, Layout.labelWidth), title);
                ...
                public static void FieldToggleAndEnable_ (this System.Object property, string title, string field, int labelOffset = 0, int toggleOffset = 0)
                {
                        Rect rect = Block.RectField();
                ...
                public static void Slider_ (this System.Object property, string title, string field, float min = 0, float max = 1)
                {
        ...
        public static class BlockExtensions
        {
                ...
                public static Header DropArrow (this Header block, string field = "foldOut", Color? colorOn = null, Color? colorOff = null, bool hide = false)
                {
                ...
                public static Header Button (this Header block, string icon = "Add", Color? color = null, string ID = "", bool hide = true, bool execute = true)
                {
                        if (!execute)
                                return block;
                        block.Add(new BlockButton(icon, color, ID, hide));
                        block.Add(new BlockSpace(6));
                        return block;
                }
                ...
                public static Header HiddenButton (this Header block, string condition, string icon, Color? color = null, string ID = "", bool hide = true, bool execute = true)
                {
                ...
                public static Header Field (this Header block, string field, float weight = 1f, bool invert = false, int rightSpace = 1, int yoffset = 0)
                {
                        block.Add(new BlockField(field, weight, invert, yoffset));
