...
namespace TwoBitMachines.TwoBitSprite.Editors
{
        public static class SpriteTreeEditor
        {
                ...
                public static List<string> spriteDirection = new List<string>() { "flipLeft", "flipRight", "flipUp", "flipDown" };
                ...
                {
                        if (Block.Header(tree).Style(Tint.SoftDark).Fold("Signals", "signalFoldOut", true, Tint.White).Build())
                        {
                ...
                private static void DisplaySignal (SerializedProperty element, SerializedProperty signal, SerializedProperty userCreated, ref int delete)
                {
                        ...
                        Block.Header(element)
                             .BoxRect(FoldOut.boxColor * active, background: "Item", height: 17, bottomSpace: 1)
