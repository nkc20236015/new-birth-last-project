...
namespace TwoBitMachines.TwoBitSprite.Editors
{
        ...
        public class SpriteEngineEditor : UnityEditor.Editor
        {
                        ...
                        serializedObject.Update();
                        {
                                ...
                                if (spriteExists)
                                {
                                        bool open = Block.Header(parent).Style(Tint.SoftDark)
                                                         ...
                                                         .TabButton("tabIndex", 2, "Signal", "Sprite Swap")
                ...
                {
                        Block.Header(parent).Style(Tint.SoftDark, background: "HeaderMiddle", noGap: true)
                             .DropArrow("open")
                             .Field(sprite.Get("name"), rightSpace: 7)
                             .Toggle("sort", "Sort")
                ...
                private void CreateDragAndDropArea (string message, Color color)
                {
                        tempSprites.Clear();
                        tempTexture2D.Clear();
                        Rect dropArea = Block.BasicRect(Layout.longInfoWidth, 88, xoffset: -11, bottomSpace: 1, texture: Skin.square, color: Tint.SoftDark);
                        {
