        ...
        public class GridItem : MonoBehaviour
        {
                ...
                public void Initialize (AI.Grid parentRef)
                {
                        ...
                        if (save && parentRef.ItemIsPurchased (ID))
                        {
                                ...
                                onHasBeenPurchased.Invoke (ImpactPacket.impact.Set (onHasBeenPurchasedWE, transform, null, transform.position, null, Vector2.zero, 0));
                        }
                }
                ...
                public void ResetAll ( )
                {
                        ...
                        {
                                onOutOfFocus.Invoke (ImpactPacket.impact.Set (onOutOfFocusWE, transform, null, transform.position, null, Vector2.zero, 0));
                        }
                        if (gridElement)
                        {
                                if (gameObject.activeInHierarchy)
                ...
                public void OnSelect ( )
                {
                        ...
                        {
                                cantPurchase.Invoke (ImpactPacket.impact.Set (cantPurchaseWE, transform, null, transform.position, null, Vector2.zero, 0));
                                return;
                        }
                        if (mustPay && parent != null && parent.payment != null)
                        {
                                ...
                                {
                                        purchaseFailed.Invoke (ImpactPacket.impact.Set (purchaseFailedWE, transform, null, transform.position, null, Vector2.zero, 0));
                                        return;
                                }
                                else
                                {
                                        ...
                                        purchaseSuccess.Invoke (ImpactPacket.impact.Set (purchaseSuccessWE, transform, null, transform.position, null, Vector2.zero, 0));
                                }

                        }

                        onSelect.Invoke (ImpactPacket.impact.Set (selectWE, transform, null, transform.position, null, Vector2.zero, 0));
                }

                public void OnFocus ( )
                {
                        onFocus.Invoke (ImpactPacket.impact.Set (onFocusWE, transform, null, transform.position, null, Vector2.zero, 0));
                }
