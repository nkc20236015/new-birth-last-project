...
namespace TwoBitMachines.FlareEngine
{
        ...
        public class Dialogue : MonoBehaviour
        {
                ...
                private void SetDialogueUI (Message message)
                {
                        ...
                        if (messenger != null && dialogueUI != null)
                        {
                                ...
                                if (animationM != null) animationM.Reset ( );
                                Sprite icon = animationM != null && animationM.sprites.Count > 0 ? animationM.sprites[0] : messenger.icon;
                                dialogueUI.StartMessage (message.type, icon, null, messenger.name, message.message, message.choice, messagePosition, message.onMessage);
                        }
                }
        ...
        public class Messenger
        {
                ...
                public MessengerAnimation GetAnimation (Message message)
                {
                        ...
                        {
                                if (animation[i].name == message.animation) return animation[i];
                        }
                        return null;
                }
        }
        ...
        public class MessengerAnimation
        {
                ...
                public void Update (Image image)
                {
                        ...
                        if (Clock.Timer (ref counter, rate))
                        {
                                ...
                                if (!loop && frameIndex == 0) block = true;
                        }
                }
        ...
        public class Choice
        {
                ...
                {
                        if (onChoice != null) onChoice.Invoke ( );
                        if (dialogue != null) dialogue.NextConversation (branchTo);
                        if (dialogueBubble != null) dialogueBubble.NextConversation (branchTo);
                }
        }
