...
#pragma warning restore 0414
                ...
                public void GrabbingItem (Firearm firearm)
                {
                        ...
                        if (grabItemState == GrabItemState.Retract)
                        {
                                ...
                                {
                                        itemReleased = true;
                                        ImpactPacket packet = ImpactPacket.impact.Set(grabCompleteWE, firearm.transform, null, firearm.firePoint.position, firearm.transform, -firearm.transform.right, 0);
