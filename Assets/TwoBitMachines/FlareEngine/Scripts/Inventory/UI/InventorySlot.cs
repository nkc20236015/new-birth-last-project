        ...
        public class InventorySlot : MonoBehaviour, ISelectHandler
        {
                ...
                public void Set (ItemUI newItemUI, Sprite icon)
                {
                        if (newItemUI != null)
                        {
                                ...
                                if (imageDrop != null) imageDrop.enabled = itemUI.droppable;
                                UpdateTextAmount ( );
                        }
                }
                ...
                public void Clear ( )
                {
                        ...
                        if (textMesh != null) textMesh.maxVisibleCharacters = 0;
                        if (imageDrop != null) imageDrop.enabled = false;
                }
                ...
                {
                        if (empty || inventory == null || inventory.dragItem == null || inventory.dragItem.active) return;
                ...
                public void OnPointerUp ( )
                {
                        ...
                        if (inventory.dragItem.canTransfer && newSlot != null && inventory.dragItem.oldSlot != newSlot)
                        {
                                ...
                                if (newSlot.rectTransform != null) inventory.MoveSelectFrame (newSlot.rectTransform.position);
                        }
                }

                public void Transfer (ItemUI newItemUI)
                {
                        if (newItemUI == null || inventory == null) return;
