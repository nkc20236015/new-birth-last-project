                ...
                public override NodeState RunNodeLogic (Root root)
                {
                        ...
                        if (water.FoundWater(root.position, false, ref waveTopPoint, ref particleIndex, force: true))
                        {
                                ...
                                if (!entered)
                                {
                                        ...
                                        onEnter.Invoke(ImpactPacket.impact.Set(onEnterWE, transform, root.world.box.collider, waveTopPoint, null, root.world.box.up, 0));
                                }
                        }
                        else if (entered)
                        {
                                ...
                                onExit.Invoke(ImpactPacket.impact.Set(onExitWE, transform, root.world.box.collider, root.position, null, root.world.box.down, 0));
                        }
...
#pragma warning disable 0414
                ...
                public override bool OnInspector (AIBase ai, SerializedObject parent, Color color, bool onEnable)
                {
                        ...
                        FoldOut.Box(3, color, extraHeight: 5, yOffset: -2);
                        {
